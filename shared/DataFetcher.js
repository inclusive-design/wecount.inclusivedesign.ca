...
export default {
	async categorizedItems (categoryType, categoryId) {
		...
		console.log("category: process.env.CONTEXT: ", process.env.CONTEXT, ", wpDomain: ", Config.wpDomain);
	...
	async sitePages () {
		...
		console.log("sitePages: process.env.CONTEXT: ", process.env.CONTEXT, ", wpDomain: ", Config.wpDomain);
